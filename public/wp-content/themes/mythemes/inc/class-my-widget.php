...
class My_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'my_widget ', // Register new Custom widgets .
			'description' => 'My Widget is awesome', // Description of the custom widgets.
		);
