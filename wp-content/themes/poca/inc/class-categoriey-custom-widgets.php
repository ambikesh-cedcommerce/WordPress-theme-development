...
class Widget_Categories extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'categories_custom', __( 'Categories_Custom' ), $widget_ops );
	}
			...
			$categories = get_terms(  apply_filters( 'widget_categories_args', $cat_args, $instance )); 
				echo '<ul class = "catagories-list">';
					foreach ($categories as $category) {
						echo '<li><a href="' . get_category_link( $category ) . '"><i class="fa fa-angle-double-right" aria-hidden="true"></i>'. $category->name .'</a></li>';
					}
				echo '</ul>';
			?>
			<?php
